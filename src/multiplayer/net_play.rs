...
pub fn net_play(player_type : PlayerType, state : &mut GameState, stream : &mut std::net::TcpStream) -> bool
{
    // Play game
    let our_move = 
    ...
    write_over_tcp::<MovePacket>(stream, &MovePacket { 0 : our_move.0 as u32, 1 : our_move.1 as u32 });
